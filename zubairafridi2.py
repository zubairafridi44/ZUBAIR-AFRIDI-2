#created by Zubair
#team name  Afridi
#tottaly written by Bilal afridi
#!/usr/bin/python3 
#---------------------[IMPORT]---------------------#
...
def freeq(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',}
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio ZUBE_OK.mp3")
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                  #  os.system("play-audio ZUBE_CP.mp3")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ZUBE 🔥] [%s] \33[1;97m[OK:%s{ZUBE2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
